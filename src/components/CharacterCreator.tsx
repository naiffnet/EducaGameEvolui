...
export const CharacterCreator: React.FC<CharacterCreatorProps> = ({ onSelectClass }) => {
  ...
  const classesConfig = [
    ...
    { id: 'NECROMANCER' as RpgClass, name: 'Necromante', specialty: 'Senhor das Sombras', desc: 'Cruzou o veu entre os vivos e os mortos e voltou diferente. O Necromante controla exercitos de espiritos e conhece segredos que o tempo apagou.', strength: 10, intelligence: 28, dexterity: 14, color: '#b794f4', bgGlow: 'rgba(183,148,244,0.15)', initialSkill: 'Invocar Espectro' },
    { id: 'QUEEN' as RpgClass, name: 'Rainha', specialty: 'Rainha Encantada', desc: 'Governante de um reino alem do horizonte, a Rainha une magia e politica em sua coroa. Sua presenca inspira exercitos e sua palavra move montanhas.', strength: 16, intelligence: 22, dexterity: 20, color: '#ffd700', bgGlow: 'rgba(255,215,0,0.15)', initialSkill: 'Aura Real' },
    ...
    { id: 'PYROMANCER' as RpgClass, name: 'Dobrador de Fogo', specialty: 'Mestre do Fogo', desc: 'Tocada pelo espirito de um dragao anciao, a pessoa dobradora de fogo carrega as chamas eternas em suas veias. Onde passa, os inimigos recuam.', strength: 20, intelligence: 20, dexterity: 12, color: '#ff9f43', bgGlow: 'rgba(255,159,67,0.15)', initialSkill: 'Bola de Fogo' },
