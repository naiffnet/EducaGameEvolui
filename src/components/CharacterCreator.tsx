...
export const CharacterCreator: React.FC<CharacterCreatorProps> = ({ onSelectClass }) => {
  ...
  const classesConfig = [
    ...
    { id: 'WARRIOR' as RpgClass, name: 'Cruzado', specialty: 'Cavaleiro da Chama', desc: 'Forjado nas guerras dos Tres Reinos, o Cruzado e o escudo dos inocentes. Sua armadura carrega as cicatrizes de mil batalhas e seu espirito nunca quebrou.', strength: 30, intelligence: 10, dexterity: 16, color: '#ff7253', bgGlow: 'rgba(255,114,83,0.15)', initialSkill: 'Golpe Flamejante' },
